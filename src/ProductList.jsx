...
function ProductList({ cartNum }) {
    ...
    const handleAddToCart = (plant) => {
        ...
        setAddedToCart(preData => ({ ...preData, [plant.name]: true }))
    }
                ...
                <div style={styleObjUl}>
                    ...
                    <div> <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}><h1 className='cart'>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" id="IconChangeColor"
                            height="68" width="68"><rect width="156" height="156" fill="none"></rect>

                            <circle cx="80"
                                cy="216" r="12"></circle><circle cx="184" cy="216" r="12"></circle>
                            ...
                            <text x="100" y="160" fontSize="100" fill="red">{cartNum}</text>
                                ...
                                <>
                                    <div className='product-grid'>
                                        ...
                                        <div className='product-card' key={index}>
                                            ...
                                            <button className='product-button' onClick={() => handleAddToCart(plant)}>Add {plant.name} To Cart</button>
                                        </div>
